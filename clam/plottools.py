...
def trig_plot_err(data, tstamp, error = 'stdv', color = 'black', linealpha = 1, erralpha = 0.15, 
                  linewidth = 2, figsize = [4,4], axdim = [0.15, 0.15, 0.75, 0.75], axis_handle = None,
                  hideaxis = True, label = None ):
